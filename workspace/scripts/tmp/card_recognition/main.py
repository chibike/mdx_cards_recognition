...
#\\Chibuike\\Projects\Clients\MiddlesexUniversity\4th Year 2018\AdvancedRobotics\ImageRecognition\card_recognition>
#\\Chibuike\\Projects\\Clients\\MiddlesexUniversity\\4th Year 2018\\AdvancedRobotics\\ImageRecognition\\card_recognition>
...
#     def __repr__(self):
#         return "c:{}, p:{}".format(self.corners, self.perimeter)
...
def read_text(img, path, contour):
...
def process_contours(contours, in_img, out_img):
    ...
    for path in paths_list:
        ...
        print ("[INFO] '{}' detected".format(read_text(in_img, path, cnt)))
